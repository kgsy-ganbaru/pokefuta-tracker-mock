export default function LoadingOverlay() {
  return (
    <div role="status" aria-live="polite" aria-label="読み込み中" className="fixed inset-0 z-50 flex items-center justify-center bg-white/75 text-gray-900 backdrop-blur-sm">
