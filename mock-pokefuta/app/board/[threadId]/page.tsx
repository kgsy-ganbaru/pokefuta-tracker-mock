...
export default async function BoardThreadPage({ params }: { params: Promise<{ threadId: string }> }) {
  const { threadId } = await params; const supabase = await createClient(); const user = await getCachedAuthProfile();
